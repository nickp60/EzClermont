...
abstract: The Clermont PCR method of phylotyping *Escherichia coli* has remained a useful classification scheme despite the proliferation of higher-resolution sequence typing schemes. We have created an *in silico* Clermont PCR method implemented as both a web app and as a command-line tool to allow researchers to easily apply this phylotyping scheme to genome assemblies. EzClermont is available as a web app at  <http://www.ezclermont.org>.  For local use, EzClermont can be installed with pip or installed from the source code at <https://nickp60.github.io/EzClermont/>.  
...
knitr::include_graphics(path =  "/Users/nick/GitHub/ezclermont/docs/analysis/tree.png")
```
